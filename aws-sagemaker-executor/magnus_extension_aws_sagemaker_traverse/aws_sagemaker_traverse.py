...
class LocalAWSSagemakerExecutor(BaseExecutor, AWSConfigMixin):
    """
    ...
    """
    service_name = 'aws-batch-traverse'
    ...
    def trigger_job(self, node: BaseNode, map_variable: dict = None, **kwargs):
        ...
        """
        self._submit_sagemaker_job(node, map_variable=map_variable, **kwargs)
    ...
    def _submit_sagemaker_job(self, node,  map_variable: dict = None, **kwargs):  # pylint: disable=unused-argument
        """"
